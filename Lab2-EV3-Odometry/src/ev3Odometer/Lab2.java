...
public class Lab2 {
	...
	public static final double WHEEL_RADIUS_R = 2.15;
	...
	public static void main(String[] args) {
		...
		OdometryCorrection odometryCorrection = new OdometryCorrection(odometer,t);
		...
		if (buttonChoice == Button.ID_LEFT) {
			...
			(new Thread() {
				public void run() {
					SquareDriver.drive(leftMotor, rightMotor, WHEEL_RADIUS, WHEEL_RADIUS_R, TRACK);
				}
			}).start();
		}
