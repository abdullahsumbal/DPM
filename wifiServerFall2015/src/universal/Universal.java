...
public class Universal {
	...
	public static TransmitRule TRANSMIT_RULE = TransmitRule.GREEN_ONLY;
	...
	public enum TransmitRule {
		RED_ONLY("red", "Transmit to red player only"),
		GREEN_ONLY("green", "Transmit to green player only"),
		BOTH("both", "Transmit to both, green and red players");
